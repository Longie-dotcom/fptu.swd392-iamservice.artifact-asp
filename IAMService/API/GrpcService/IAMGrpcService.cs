    ...
    public class IAMGrpcService : IAMGrpc.IAMGrpcBase
    {
            ...
            ServerCallContext context)
        {
            ...
            var response = new GetUserResponse
            {
                ...
                Gender = user.Gender,
                IsActive = true,
                Dob = Timestamp.FromDateTime(DateTime.SpecifyKind(user.Dob, DateTimeKind.Utc))
            };
            ...
            ServerCallContext context)
        {
            try
            {
                var userId = await userService.CreateUserGrpcAsync(request);
            ...
            {
                throw new RpcException(
                    new Status(StatusCode.Internal, "INTERNAL_SERVER_ERROR"));
            }
        }
        #endregion
    }
